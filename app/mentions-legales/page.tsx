...
export default function MentionsLegales() {
  return (
    ...
    <section className="classNamp-6">
        <h2 className="font-semibold mb-4">Éditeur du site</h2>
        ...
        <p><strong>SIRET :</strong> 9521675670001</p>
    ...
    <section className="classNamp-6 mt-6">
        <h2 className="font-semibold mb-4">Hébergeur du site</h2>
    ...
    <section className="classNamp-6 mt-6">
        <h2 className="font-semibold mb-4">Propriété intellectuelle</h2>
    ...
    <section className="classNamp-6 mt-6">
        <h2 className="font-semibold mb-4">Responsabilité</h2>
    ...
    <section className="classNamp-6 mt-6">
        <h2 className="font-semibold mb-4">Droit applicable et juridiction compétente</h2>
    ...
    <section className="classNamp-6 mt-6">
        <h2 className="font-semibold mb-4">Politique de confidentialité de Laser Art Show</h2>
    ...
    <section className="classNamp-6 mt-6">
        <h3 className="text-xl font-semibold mb-4">Données collectées</h3>
    ...
    <section className="classNamp-6 mt-6">
        <h3 className="text-xl font-semibold mb-4">Utilisation des données</h3>
    ...
    <section className="classNamp-6 mt-6">
        <h3 className="text-xl font-semibold mb-4">Partage des données</h3>
    ...
    <section className="classNamp-6 mt-6">
        <h3 className="text-xl font-semibold mb-4">Conservation des données</h3>
